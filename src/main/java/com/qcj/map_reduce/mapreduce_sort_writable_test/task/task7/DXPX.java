package com.qcj.map_reduce.mapreduce_sort_writable_test.task.task7;
...
public class DXPX {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Path inpath = new Path("hdfs://hadoop1:9000/dxpx");
            FileInputFormat.addInputPath(job,inpath);
            Path outpath = new Path("hdfs://hadoop1:9000/dxpx_out");
