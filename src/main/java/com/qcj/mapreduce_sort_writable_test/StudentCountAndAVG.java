package com.qcj.mapreduce_sort_writable_test;
 ...
 * 3、统计每一个学生的每一门课程的平均分
 */
public class StudentCountAndAVG {
    public static void main(String[] args) {
        Configuration configuration = new Configuration();
        try {
            Job job = Job.getInstance(configuration);
            job.setJarByClass(StudentCountAndAVG.class);
            ...
            Path outpath = new Path("hdfs://hadoop1:9000/out_avg_score3");
