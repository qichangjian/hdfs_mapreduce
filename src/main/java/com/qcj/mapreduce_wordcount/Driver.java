package com.qcj.mapreduce_wordcount;
 ...
 *
 * 运行方式，打jar包
 *  eclipse右键导出jarfile选择位置，起名字
 *        方式一：直接结束
 *        方式二：下一步next,指定main函数（brows选）
 *        C:\Users\Administrator\IdeaProjects\mapreducehelloworld\src\main\java\com\qcj\mapreduce\Driver.java
 */
public class Driver {
    public static void main(String[] args) {
        ...
        try {
            ...
            //设置整个job的mapper对应的类
            job.setMapperClass(WordContMapper.class);
            //设置真个job的reducer对象的类
